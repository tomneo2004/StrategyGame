...
/// <summary>
/// This class FarmlandBuildingMetaData is automatic generated.
/// 
/// Implement your persistant data calss here
/// </summary>
[Serializable]
public class FarmlandBuildingMetaData : PersistantMetaData
{
	public ResourceType resourceId = ResourceType.Food;
	
	public int collectPerDuration = 40;
	
	public float resourceRegenPerDuration = 2000f;
	...
	/// <summary>
	/// Starts the resource regen task.
	/// </summary>
	...
	public void Save()
	{
		SaveLoadManager.SharedManager.Save <FarmlandBuildingMetaData>(this);
	}
}