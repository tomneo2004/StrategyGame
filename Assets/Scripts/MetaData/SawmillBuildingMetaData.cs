...
/// <summary>
/// This class SawmillBuildingMetaData is automatic generated.
/// 
/// Implement your persistant data calss here
/// </summary>
[Serializable]
public class SawmillBuildingMetaData : PersistantMetaData
{
	public ResourceType resourceId = ResourceType.Wood;
	
	public int collectPerDuration = 30;
	
	public float resourceRegenPerDuration = 1000f;
	
	public float maxResourceStore = 100000f;
	...
	public static SawmillBuildingMetaData Load(bool processing = false)
	{
		if(!SaveLoadManager.SharedManager.IsFileExist<SawmillBuildingMetaData>())
		{
			SawmillBuildingMetaData newData = new SawmillBuildingMetaData();
		...
		SawmillBuildingMetaData data = SaveLoadManager.SharedManager.Load<SawmillBuildingMetaData> ();
	...
	public void Save()
	{
		SaveLoadManager.SharedManager.Save <SawmillBuildingMetaData>(this);
	}
}